...
//create links table
$query = "CREATE TABLE IF NOT EXISTS tbl_links (url_name varchar(255) NOT NULL,url text NOT NULL,user varchar(255), type varchar(255) NOT NULL,active char(1) NOT NULL, PRIMARY KEY  (url_name))";
$result = $DbConnect->query($query);
